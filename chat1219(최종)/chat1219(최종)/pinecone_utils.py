...
def query_pinecone(fornext):  # Use 'fornext' instead of 'usumma'
    pinecone_results = query_pinecone_with_metadata(fornext, 'messispace', pinecone_index, tokenizer, model)
